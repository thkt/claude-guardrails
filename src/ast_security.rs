...
use oxc_ast::ast::{
    ...
    LogicalExpression, MethodDefinition, ObjectProperty, ObjectPropertyKind, Program,
    RegExpLiteral, ReturnStatement, Statement, StaticMemberExpression, VariableDeclarator,
};
