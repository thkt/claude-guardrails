...
| `naming` | Mixed | Naming conventions (components, interfaces, types) | Inconsistent PascalCase defeats code search and the pattern recognition that picks these out | Different naming conventions in team/project |
