...
| [0023](0023-stateless-path-consistent-semantic-invariant-gate.md)           | semantic invariant gate を stateless かつ path-consistent に保つ (git/diff baseline を持たず、pin key は read と同じ canonicalize 経路から導出する)             | accepted   | 2026-06-24 |
| [0024](0024-test-assertion-quality-expect-chain-scope-contract.md)          | test-assertion の品質判定を expect() chain に限定し、実アサーション 1 つで body 全体を redeem する                                                              | accepted   | 2026-06-24 |
